...
pub use crate::parser::{
    detect_session_state, has_incomplete_line, open_stream, ActiveSessionParser, ProgressCallback,
    ProgressStreamingParser, SessionState, StreamingIterator, StreamingParser, StreamingProgress,
};
...
pub fn open_session_stream(
    ...
    StreamingParser<std::io::BufReader<std::fs::File>>,
    SessionState,
)> {
